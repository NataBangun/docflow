...
class Mm_categories extends CI_Model {
    ...
    public function get() {
        $sql = "SELECT DBDOC.P_CATEGORIES.PK_CATEGORIES_ID, DBDOC.P_CATEGORIES.CATEGORIES_STATUS, DBDOC.P_CATEGORIES.CATEGORIES_TITLE, DBDOC.P_CATEGORIES.CATEGORIES_CDT, DBDOC.P_CATEGORIES.CATEGORIES_CBY, DBDOC.P_CATEGORIES.FK_TYPE_ID,DBDOC.P_CATEGORIES.CATEGORIES_STATUS, DBDOC.P_TYPE.PK_TYPE_ID, DBDOC.P_TYPE.TYPE_NAME FROM DBDOC.P_CATEGORIES INNER JOIN DBDOC.P_TYPE ON DBDOC.P_CATEGORIES.FK_TYPE_ID = DBDOC.P_TYPE.PK_TYPE_ID";
