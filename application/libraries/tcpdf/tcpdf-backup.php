...
class TCPDF {
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = 'halaman '.$w_page.$this->getAliasNumPage().' dari '.$this->getAliasNbPages(). ' halaman';
		} else {
			$pagenumtxt = 'halaman '.$w_page.$this->getPageNumGroupAlias().' dari '.$this->getPageGroupAlias(). ' halaman';
		}
		$this->SetY($cur_y);
		//Print page number
		if ($this->getRTL()) {
