...
class TCPDF {
	 ...
	 * @public
	 */
	public function setHeaderMargin($hm=-2000) {
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = 'Hal. '.$w_page.$this->getAliasNumPage().' dari '.$this->getAliasNbPages(). ' halaman';
		} else {
			$pagenumtxt = 'Hal. '.$w_page.$this->getPageNumGroupAlias().' dari '.$this->getPageGroupAlias(). ' halaman';
		}
		$this->SetY($cur_y);
		//Print page number
